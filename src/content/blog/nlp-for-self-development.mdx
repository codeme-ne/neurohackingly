...
![A brain with gears on it and a lightbulb in handdrawn style showing "How to use NLP for Self Development"](/images/nlp-for-self-development/neurohackingly-com-nlp-for-self-development--image-2.png)
...
![Shortform-Summaries cover of Tony Robbins Books "Awaken the Giant Within", "Life Force", "Money Master the Game" and "Unlimited Power".](/images/nlp-for-self-development/tony_robbins_books_shortform.png)
...
![How the book-summary "Life Force" looks like on Shortform (short book-summary and QR Code to install the app](/images/nlp-for-self-development/life_force_tony_robbins_shortform.png)
...
![In the background are mountains in blue and it is written as a quote from Tony Robbins in the foreground: Knowlege is not power. Knowledge is only potential power. Action is power.](/images/nlp-for-self-development/Knowledge-is-not-power.-Knowledge-is-only-potential-power.-Action-is-power..png)
...
![questions from the blogpost "Journal for 1 hour" which I always ask myself in the morning and evening](/images/nlp-for-self-development/journal-morning-and-evening-nlp-questions.png)
...
<GifVideo alt="Mirroring. 2 Men imitate everything the other one does (not exactly how mirroring works)" webm="/images/nlp-for-self-development/mirror-duck-soup.webm" mp4="/images/nlp-for-self-development/mirror-duck-soup.mp4" poster="/images/nlp-for-self-development/mirror-duck-soup.jpg" />
...
![A Triangle is shown with the forces that control your emotions. State is written in the middle of the triangle and the sides which influence your State are Psychology, Focus and Language.](/images/nlp-for-self-development/state_triangle_tony_robbins_nlp.svg)
...
![powerful words are written on this page, like beautiful, magical, awesome and extraordinary](/images/nlp-for-self-development/Untitled.png)
...
![a pyramid: bottom to top: physical body, emotions & meaning, relationships, time, work/career/mission, finances, celebrate & contribute](/images/nlp-for-self-development/the-wheel-of-life-from-tony-robbins-for-self-improvement.png)
...
![Vision Board divided into different areas. You can see different photos of goals I want to, or have already achieved.](/images/nlp-for-self-development/20221001_032452.jpg)
